...
(function () {
    ...
    angular.module('App').controller('Budgeting', Budgeting);
    Budgeting.$inject = [
        '$scope',
        '$state',
        '$filter',
    ...
    function Budgeting($scope, $state, $filter, alertify, suppliersRepository, users, ar5sspresntage, $rootScope, dtOptionsBuilder, dtColumnDefBuilder, salesRepository) {
        $scope.Users = users;
        $scope.Total = 0;
        ...
        function getBasicData() {
            ...
            suppliersRepository.GetBudGeting(mabdparms).then(function (result) {
        ...
        $scope.search = function () {
            ...
            suppliersRepository.GetBudGeting($scope.SalesReport).then(function (result) {
                $scope.SerachResult = result.data.output;
                // $scope.NumberOfOperation = result.data[0].NumberOfOperation;
                // $scope.NumberOfProduct = result.data[0].NumberOfProduct;
                // for (var i = 0; i < $scope.SerachResult.length; i++) {
