...
(function () {
    ...
    angular.module('App').controller('RefusedOrder', RefusedOrder);
    RefusedOrder.$inject = [
        '$scope',
        '$state',
        'alertify',
    ...
    function RefusedOrder($scope, $state, alertify, salesRepository, size, category, brand, product, users, $rootScope, dtOptionsBuilder, dtColumnDefBuilder) {
