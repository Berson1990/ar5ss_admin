...
(function () {
    ...
    angular.module('App').controller('SalesPendingReport', SalesPendingReport);
    SalesPendingReport.$inject = [
        '$scope',
        '$state',
        'alertify',
        'SalesRepository',
    ...
    function SalesPendingReport($scope, $state, alertify, salesRepository, size, category, brand, product, users, $rootScope, dtOptionsBuilder, dtColumnDefBuilder) {
