...
(function () {
    ...
    angular.module('App').controller('SalesReport', SalesReport);
    SalesReport.$inject = [
        '$scope',
        '$state',
        'alertify',
    ...
    function SalesReport($scope, $state, alertify, salesRepository, size, category, brand, product, users, $rootScope, dtOptionsBuilder, dtColumnDefBuilder) {
