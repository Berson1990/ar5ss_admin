...
(function () {
    ...
    angular.module('App').controller('ProductUnderUpdateManagment', ProductUnderUpdateManagment);
    ProductUnderUpdateManagment.$inject = [
        '$scope', '$uibModal',
        'alertify', 'ProductRepository', 'Size', 'Category', 'Brand',
        'DTOptionsBuilder', 'DTColumnDefBuilder', 'ProductList', '$rootScope','$filter'
    ];

    function ProductUnderUpdateManagment($scope, $uibModal, alertify, productRepository, size, category, brand, dtOptionsBuilder, dtColumnDefBuilder, productList, $rootScope,$filter) {
        ...
        function getproduct() {
            ...
            productRepository.ProductUnderUpdate($rootScope.CurrentUser.UserID).then(function (productList) {
