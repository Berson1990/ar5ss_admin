...
(function () {
    ...
    angular.module('App').controller('Baddebt', Baddebt);
    Baddebt.$inject = [
        '$scope',
        '$state',
        'alertify',
    ...
    function Baddebt($scope, $state, alertify, suppliersRepository, users, ar5sspresntage, $rootScope, dtOptionsBuilder, dtColumnDefBuilder,salesRepository) {
        $scope.Users = users;
        $scope.Total = 0;
        ...
        function getBasicData() {
            ...
            suppliersRepository.ExcutedOrders(mabdparms).then(function (result) {
        ...
        $scope.search = function () {
            ...
            suppliersRepository.ExcutedOrders($scope.SalesReport).then(function (result) {
                $scope.SerachResult = result.data.output;
