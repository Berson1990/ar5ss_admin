...
(function () {
    ...
    angular.module('App').controller('AdministrativeCirculars', AdministrativeCirculars);
    AdministrativeCirculars.$inject = [
        '$scope', '$uibModal',
        'alertify', 'SuppliersRepository', '$filter',
        'DTOptionsBuilder', 'DTColumnDefBuilder', 'AdminCirculList'
    ];

    function AdministrativeCirculars($scope, $uibModal, alertify, suppliersRepository, $filter, dtOptionsBuilder, dtColumnDefBuilder, adminCirculList) {
