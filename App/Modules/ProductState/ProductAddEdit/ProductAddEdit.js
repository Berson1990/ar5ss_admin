...
(function () {
    ...
    ProductAddEdit.$inject = [
        ...
        'Brand', 'Category', 'Size', 'Product', 'IsEditMode'
    ];

    function ProductAddEdit($scope, $uibModal, $rootScope, $uibModalInstance, ProductRepository, brand, category, size, product, isEditMode) {
